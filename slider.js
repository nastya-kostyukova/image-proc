function slider(elemId, sliderWidth, range1, range2, step, nameInfo) {
...
// point - количество пикселей на единицу значения
    ...
    offsX = knobWidth/2;
    knob.style.left = knobWidth/2;            // бегунок в нулевое значение
...
//////////////////// функции установки/получения значения //////////////////////////
    ...
    function setValue(x)    // установка по пикселям
    {
        ...
        elemInfo.innerHTML = getValue();    // это вывод значения для примера
    }
